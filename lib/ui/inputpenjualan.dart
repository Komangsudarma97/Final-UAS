...
class MyCustomFormState extends State<MyCustomForm> {
  ...
  TextEditingController jenis_kacamataController = TextEditingController();
  ...
  Future<http.Response> adddata(index) async {
    if (index == null) {
      final http.Response response = await http
        ...
        'jenis_kacamata': jenis_kacamataController.text,
  ...
  void initState() {
    if (widget.index == null) {
      ...
      jenis_kacamataController = TextEditingController();
      jumlahController = TextEditingController();
      hargaController = TextEditingController();
      tanggalController = TextEditingController();
    } else {
      nameController = TextEditingController(text: widget.list['nama']);
      jenis_kacamataController =
          TextEditingController(text: widget.list['jenis_kacamata']);
      ...
      child: ListView(
        children: <Widget>[
          ...
          Padding(
            ...
            child: TextFormField(
              controller: jenis_kacamataController,
              keyboardType: TextInputType.text,
              decoration: InputDecoration(
                labelText: "Jenis Kacamata",
                border: OutlineInputBorder(
                    borderRadius: BorderRadius.circular(3.0)),
              ),
              validator: (value) {
                if (value.isEmpty) {
                  return 'Mohon isi jenis kacamata yang dipilih';
                }
                return null;
              },
            ),
